    ...
    children: <Widget>[
      ...
      Text('Mobile No : '),
          GestureDetector(
            onTap: (){
    launch(
               'tel:00'+myAdvisorsJson[index]['MobileNo'].toString()
    );
            },
...
//
                          ...
                          '00'+myAdvisorsJson[index]['MobileNo'].toString()
                              :

                          ''+myAdvisorsJson[index]['MobileNo'].toString()
,
          ...
          GestureDetector(
                onTap: (){
                  launch(
                      ...
                      'mailto:'+myAdvisorsJson[index]['MailId'].toString()

                  );
                },
            
            child: Text(myAdvisorsJson[index]['MailId'],style: TextStyle(
                decoration: TextDecoration.underline,
                color: Colors.blue),)),
    ],
  ),
...
Padding(
  ...
  child:   Row(
    children: <Widget>[
      ...
      Text('With TOC : '),
          Text(myAdvisorsJson[index]['With TOC']== null ? 'No':myAdvisorsJson[index]['With TOC']),
    ],
  ),
),
SizedBox(height: 10,),
Padding(
  ...
  child:   Row(
    children: <Widget>[
      ...
      Text('With Sap : '),
          Text(myAdvisorsJson[index]['WithSap'] =='' ? 'No' : myAdvisorsJson[index]['WithSap']),
    ],
  ),
),
SizedBox(height: 10,),
Padding(
  ...
  child:   Row(
    children: <Widget>[
      ...
      Text('Shift Time : '),
          Text(myAdvisorsJson[index]['shift'] =='E' ? 'Evening': myAdvisorsJson[index]['shift'] == 'M' ? 'Morning' : myAdvisorsJson[index]['shift'] == 'W' ? 'Weekend' : '' ),
    ],
  ),
),
SizedBox(height: 10,),
  ...
  child:   Row(
    children: <Widget>[
      ...
      Text('Repeating Course : '),
          Text(myAdvisorsJson[index]['Repeating Course'] == '' ? 'No' :'Yes' ),
    ],
  ),
),
SizedBox(height: 10,),
Padding(
  padding: const EdgeInsets.only(left:10.0),
  child:   
myAdvisorsJson[index]['CondAdm'] == '' ? SizedBox():  

  Row(
    children: <Widget>[
  
      Text('CondAdm : '),
          Text(myAdvisorsJson[index]['CondAdm']== null ? '': myAdvisorsJson[index]['CondAdm']),
    ],
  ),
),
