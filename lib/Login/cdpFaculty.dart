...
void main() => runApp(CdpFaculty());

class CdpFaculty extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _CdpFacultyState();
  }
}

// Map<String, int> body;

class _CdpFacultyState extends State<CdpFaculty> with TickerProviderStateMixin {
  List cdpCourseJson = [];
