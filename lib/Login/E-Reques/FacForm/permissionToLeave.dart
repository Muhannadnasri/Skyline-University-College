              ...
              Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    }, 'Address while on leave', TextInputType.text),
                    globalForms(context, '', (String value) {
                      if (value.trim().isEmpty) {
                    ...
                    }, 'Reason for travel', TextInputType.text),
                    globalForms(context, '', (String value) {
                      if (value.trim().isEmpty) {
                    ...
                    }, 'Relationship', TextInputType.text),
                    globalForms(context, '', (String value) {
                      if (value.trim().isEmpty) {
                    ...
                    }, 'Offie Phone Number', TextInputType.number),
                    globalForms(context, '', (String value) {
                      if (value.trim().isEmpty) {
                        return 'Address is required';
                      }
    ...
    try {
      final response = await http.post(
        ...
        body: {
          ...
          'LeaveTo': to.toString(),
          'AddressWhileOnLeave': addressLeave,
          'ReasonForTravel': reasonTravel,
          'Name': emergencyName,
          'Email': emergencyEmail,
          'Relationship': emergencyRelationship,
          'MobileNo': emergencyMobile,
          'TelephoneNoResidence': emergencyPhoneNumber,
          'TelephoneNoOffice': emergencyOfficePhone,
