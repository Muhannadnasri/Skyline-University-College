...
import 'package:skyline_university/calendar/src/calendar_header.dart';
import 'package:skyline_university/calendar/src/weekday_row.dart';
import 'package:intl/date_symbol_data_local.dart';
import 'package:intl/intl.dart' show DateFormat;
// import 'package:skyline_university/calendar/src/calendar_header.dart';
export 'package:skyline_university/calendar/classes/event_list.dart';
          ...
          if (eventIndex < 5) {
            if (widget.markedDateIconBuilder != null) {
              ...
              if (widget.markedDateWidget != null) {
                Event thisEvent = event as Event;
                tmp.add(Container(
                  height: 3,
                  width: 3,
                  decoration: new BoxDecoration(
                    color: thisEvent.title == "PRESENT"
                        ? Colors.green
                        : Colors.red,
