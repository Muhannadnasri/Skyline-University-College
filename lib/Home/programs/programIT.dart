...
void main() => runApp(ProgramIT());

class ProgramIT extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ProgramITState();
  }
}
        ...
        child:  ListView.builder(
          itemCount: programIT.length,
            itemBuilder: (BuildContext context, int index) {
              ...
              programIT[index]['Title'] != 'BS IT-EC (Enterprise Computing)' ? SizedBox():
  ...
  Future getProgramIT() async {
    ...
    try {
      ...
      if (x.toString().contains("TimeoutException")) {
        ...
        showError("Time out from server", FontAwesomeIcons.hourglassHalf,context,getProgramIT);
      } else {
          showLoading(false,context);
        showError("Sorry, we can't connect", Icons.perm_scan_wifi,context,getProgramIT);
      }
    }
  }
}
