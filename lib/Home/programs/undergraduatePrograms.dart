...
void main() => runApp(UndergraduatePrograms());

class UndergraduatePrograms extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _UndergraduateProgramsState();
  }
}
...
class _UndergraduateProgramsState extends State<UndergraduatePrograms> {
  @override
  void initState() {
    super.initState();
    getPrograms();
