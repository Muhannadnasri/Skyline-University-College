...
void main() => runApp(ExecutiveDevelopmentProgram());

class ExecutiveDevelopmentProgram extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ExecutiveDevelopmentProgramState();
  }
}

List programsJson = [];

class _ExecutiveDevelopmentProgramState
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(fontSize: 13, color: isDark(context)
                                              ? Colors.white
                                              : Colors.black),
                                      ),
                                    ),
