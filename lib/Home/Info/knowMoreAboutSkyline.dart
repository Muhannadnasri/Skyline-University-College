...
void main() => runApp(KnowMoreAboutSkyline());

class KnowMoreAboutSkyline extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _KnowMoreAboutSkylineState();
  }
}

class _KnowMoreAboutSkylineState extends State<KnowMoreAboutSkyline> {
  List infoJson = [];
