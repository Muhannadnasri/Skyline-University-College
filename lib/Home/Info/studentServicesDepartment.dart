...
void main() => runApp(StudentServicesDepartment());

class StudentServicesDepartment extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _StudentServicesDepartmentState();
  }
}

class _StudentServicesDepartmentState extends State<StudentServicesDepartment> {
  List infoJson = [];
