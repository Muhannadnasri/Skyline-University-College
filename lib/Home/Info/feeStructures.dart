  ...
  Future getFeeStructures() async {
    ...
    try {
      final response = await http.post(
        Uri.encodeFull(
            'https://skylineportal.com/moappad/api/web/getFeeStructures'),
        headers: {
          "API-KEY": API,
        },
        body: {
      ...
      if (x.toString().contains("TimeoutException")) {
        ...
        showError("Time out from server", FontAwesomeIcons.hourglassHalf,context,getFeeStructures);
      } else {
          showLoading(false,context);
        showError("Sorry, we can't connect", Icons.perm_scan_wifi,context,getFeeStructures);
      }
    }
  }
